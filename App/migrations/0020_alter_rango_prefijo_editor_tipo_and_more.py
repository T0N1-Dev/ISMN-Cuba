# Generated by Django 5.0.4 on 2024-08-03 14:31
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('App', '0019_alter_rango_prefijo_editor_tipo_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='tema',
            name='idioma',
            field=models.CharField(choices=[('FR', 'Francés'), ('AL', 'Alemán'), ('ES', 'Español'), ('IT', 'Italiano'), ('RU', 'Ruso'), ('PO', 'Portugués'), ('EN', 'Inglés')], max_length=50),
        ),
    ]
